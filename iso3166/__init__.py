...
_records = [
    ...
    Country(u"Brunei Darussalam", "BN", "BRN", "096", u"Brunei"),
    ...
    Country(u"Cocos (Keeling) Islands", "CC", "CCK", "166", u"Cocos Islands"),
    ...
    Country(u"Iran, Islamic Republic of", "IR", "IRN", "364", u"Iran"),
    ...
    Country(u"Lao People's Democratic Republic", "LA", "LAO", "418", u"Laos"),
    ...
    Country(u"Russian Federation", "RU", "RUS", "643", u"Russia"),
    ...
    Country(u"Syrian Arab Republic", "SY", "SYR", "760", u"Syria"),
    Country(u"Taiwan, Province of China", "TW", "TWN", "158", u"Taiwan"),
    Country(u"Tajikistan", "TJ", "TJK", "762", u"Tajikistan"),
    Country(u"Tanzania, United Republic of", "TZ", "TZA", "834", u"Tanzania"),
    Country(u"Thailand", "TH", "THA", "764", u"Thailand"),
    Country(u"Timor-Leste", "TL", "TLS", "626", u"East Timor"),
    ...
    Country(u"Venezuela, Bolivarian Republic of", "VE", "VEN", "862",
            u"Venezuela"),
    Country(u"Viet Nam", "VN", "VNM", "704", u"Vietnam"),
